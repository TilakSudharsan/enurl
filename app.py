...
openai.api_key = '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'
    ...
    try:
       # Check if a file is uploaded
        if 'file' not in request.files:
            return render_template('no_file_uploaded.html')  # Render a template indicating no file uploaded
